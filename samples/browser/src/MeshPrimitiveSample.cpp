...
void MeshPrimitiveSample::initialize()
{
    ...
    _triangles->setMaterial("res/bgfxshaders/Colored_VS.bin", "res/bgfxshaders/Colored_FS.bin", "VERTEX_COLOR");
    ...
    Material* material = _triangleStrip->setMaterial("res/bgfxshaders/Colored_VS.bin", "res/bgfxshaders/Colored_FS.bin", "VERTEX_COLOR");
    ...
    _lineStrip->setMaterial("res/bgfxshaders/Colored_VS.bin", "res/bgfxshaders/Colored_FS.bin", "VERTEX_COLOR");
    
    Mesh* lineMesh = createLinesMesh();
    _lines = Model::create(lineMesh);
    SAFE_RELEASE(lineMesh);
    _lines->setMaterial("res/bgfxshaders/Colored_VS.bin", "res/bgfxshaders/Colored_FS.bin", "VERTEX_COLOR");
}
