...
GL2IndexBuffer::GL2IndexBuffer(const unsigned int indexFormat, unsigned int indexCount, bool dynamic)
{
...
void GL2IndexBuffer::set(const void* indexData, unsigned int indexCount, unsigned int indexStart)
{
    GL_ASSERT( glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, _ibh) );
